...
* [GoDoc](https://godoc.org/github.com/filecoin-heiben/go-fil-markets/storagemarket) contains an architectural overview and robust API documentation

* Storage Client FSM diagram:

[![Diagram of StorageClientFSM](../docs/storageclient.mmd.png)](https://raw.githubusercontent.com/filecoin-project/github.com/filecoin-heiben/go-fil-markets/master/docs/storageclient.mmd.svg)


* Storage Provider FSM diagram:

[![Diagram of StorageClientFSM](../docs/storageprovider.mmd.png)](https://raw.githubusercontent.com/filecoin-project/github.com/filecoin-heiben/go-fil-markets/master/docs/storageprovider.mmd.svg)
